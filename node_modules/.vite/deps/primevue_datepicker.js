import {
  script as script9
} from "./chunk-GOICEJFB.js";
import {
  script as script8
} from "./chunk-LKH54B7C.js";
import {
  script as script7
...
var script11 = {
  ...
  methods: {
    ...
    isSelected: function isSelected(dateMeta) {
      ...
      if (this.d_value) {
        if (this.isSingleSelection()) {
          ...
          if (this.d_value[1])
            return this.isDateEquals(this.d_value[0], dateMeta) || this.isDateEquals(this.d_value[1], dateMeta) || this.isDateBetween(this.d_value[0], this.d_value[1], dateMeta);
          else {
    ...
    shouldSelectDate: function shouldSelectDate() {
      if (this.isMultipleSelection())
        return this.maxDateCount != null ? this.maxDateCount > (this.d_value ? this.d_value.length : 0) : true;
      else
        return true;
    },
