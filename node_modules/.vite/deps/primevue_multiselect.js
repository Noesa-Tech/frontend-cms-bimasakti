...
import {
  script as script4
} from "./chunk-IREFWWLQ.js";
import {
  script as script6
} from "./chunk-TCY4Q3ED.js";
import {
  script as script7
} from "./chunk-FXBRHOVJ.js";
import {
  OverlayEventBus
...
var script14 = {
  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      var value = null;
      if (selected)
        value = this.d_value.filter(function(val) {
          return !equals(val, _this4.getOptionValue(option2), _this4.equalityKey);
        });
      else
        value = [].concat(_toConsumableArray(this.d_value || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0)
              filtered.push(_objectSpread(_objectSpread({}, group), {}, _defineProperty$1({}, typeof _this25.optionGroupChildren === "string" ? _this25.optionGroupChildren : "items", _toConsumableArray(filteredItems))));
          });
