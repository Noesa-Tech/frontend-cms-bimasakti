...
const query = reactive({
    ...
    service: {
        id: props.detail.service.id,
        name: props.detail.service.name,
        image_url: props.detail.image_url
    },
...
async function onSave() {
    ...
    await $serviceCategory.updateServiceCategory(props.detail.id, payload)
    emit('on-save')
}
...
<template>
    ...
    <div class="flex flex-col gap-2 mb-4">
        ...
        <Select v-model="query.service" :value="query.service" optionLabel="name" :options="items" placeholder="Pilih Layanan">
