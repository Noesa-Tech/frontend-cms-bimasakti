...
<template>
  <div class="bg-surface-0 py-4 px-4 sticky top-0">
    <div class="container mx-auto flex justify-between gap-4">
      <img src="https://www.bimasakti.homes/_next/image?url=%2Flogo.png&w=1080&q=75" alt="Logo" class="h-8" />
      <Button icon="pi pi-download" label="Unduh" severity="secondary" text v-tooltip.bottom="'Unduh'" />
    </div>
  </div>
  <div class="pt-8">
